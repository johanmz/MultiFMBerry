...
void ns741_init_registers(uint8_t nr_transmitters); // set the N741 register map for every transmitter
int ns741_init_i2c (uint8_t bus, uint8_t nr_transmitters); // initialise i2c bus for the transmitters
void ns741_init_rds_registers(uint8_t nr_transmitters); // initialise rds registers
...
void ns741_rds_reset_radiotext(uint8_t transmitter); // toggle Reset flag
